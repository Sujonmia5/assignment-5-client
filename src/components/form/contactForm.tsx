  ...
  return (
    <div className="h-screen bg-gray-100">
      <section className=" w-full h-full text-white">
        <div className="grid w-full h-full grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
          <div className="py-6 md:py-0 md:px-6 bg-header-bg bg-no-repeat bg-cover bg-center w-full h-full rounded-[50px] flex flex-col items-center  justify-center space-y-5">
            <h1 className="text-6xl font-bold w-full">
              Reach Us <br />
              Anytime!
            </h1>
            <p className="pt-2 pb-4 w-full">
